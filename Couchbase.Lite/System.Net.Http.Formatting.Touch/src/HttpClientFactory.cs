            ...
            foreach (DelegatingHandler handler in reversedHandlers)
            {
                if (handler == null)
                {
					throw new ArgumentException("handlers", "DelegatingHandlerArrayContainsNullItem: " + typeof(DelegatingHandler).Name);
						//Error.Argument("handlers", Properties.Resources.DelegatingHandlerArrayContainsNullItem, typeof(DelegatingHandler).Name);
                }
                ...
                if (handler.InnerHandler != null)
                {
					...
					//Error.Argument("handlers", Properties.Resources.DelegatingHandlerArrayHasNonNullInnerHandler, typeof(DelegatingHandler).Name, "InnerHandler", handler.GetType().Name);
                }
